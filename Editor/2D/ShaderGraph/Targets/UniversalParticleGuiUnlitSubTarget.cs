...
{
    sealed class UniversalParticleGuiUnlitSubTarget : UniversalSubTarget, ILegacyTarget
    
    {
        static readonly GUID kSourceCodeGuid = new GUID("ed7c0aacec26e9646b45c96fb318e5a3"); // UniversalParticleGuiUnlitSubTarget.cs

        public UniversalParticleGuiUnlitSubTarget()
        {
